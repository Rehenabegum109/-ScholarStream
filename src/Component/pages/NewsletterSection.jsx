...
const NewsletterSection = () => (
  <section className="py-20 bg-base-100 text-center">
    ...
    <p className="mb-6 text-base-content">Get the latest scholarships and updates directly in your inbox.</p>
    <form className="flex flex-col md:flex-row justify-center gap-4 max-w-xl mx-auto">
      <input type="email" placeholder="Your email" className="input text-base-content input-bordered w-full md:w-auto" />
